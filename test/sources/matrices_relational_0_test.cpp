...
TEST(matrices_tests, symmetric_equal_to_matrix_0_test)
{
...
TEST(matrices_tests, asymmetric_equal_to_matrix_0_test)
{
  using namespace primordialmachine;
...
TEST(matrices_tests, not_equal_to_matrix_0_test)
{
  using namespace primordialmachine;
