...
struct binary_minus_functor<matrix<TRAITS>, matrix<TRAITS>, void>
  : public elementwise_binary_matrix_functor<
      TRAITS,
      binary_minus_functor<typename TRAITS::element_type,
...
{
  return binary_minus_functor<matrix<TRAITS>, matrix<TRAITS>>()(u, v);
}
